...
1) **Android 行動應用程式**
   ...
   [使用 Experience Platform Mobile SDK 設定推播管道](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/push-channel/configure-push-using-aep-mobile-sdk.html?lang=zh-Hant)
